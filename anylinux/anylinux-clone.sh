...
# ~/Downloads/uekulele-master/ubuntu-clone.sh MajorRelease MinorRelease NumCon
...
# Running the command:
# ~/Downloads/uekulele-master/ubuntu-clone.sh 6 7 4
...
clear
~/Downloads/uekulele-master/anylinux-services-4.sh $1 $2 $3 ora$1$2c
clear
~/Downloads/uekulele-master/anylinux-services-5.sh $1 $2
